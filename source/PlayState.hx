			...
			switch (spr.ID)
			{
				case 0:
					...
					{	
						...
						spr.color = Note.dadcolorsNote[0];
					}
				case 1:
					if (spr.animation.finished)
						spr.animation.play('static');
					...
					{	
						...
						spr.color = Note.dadcolorsNote[1];
					}
				case 2:
					if (spr.animation.finished)
						spr.animation.play('static');
					...
					{	
						...
						spr.color = Note.dadcolorsNote[2];
					}
				case 3:
					if (spr.animation.finished)
						spr.animation.play('static');
					...
					{	
						...
						spr.color = Note.dadcolorsNote[3];
					}
			}
