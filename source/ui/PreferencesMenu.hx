...
class PreferencesMenu extends ui.OptionsState.Page
{
	...
	public function new()
	{
		...
		createPrefItem('health drain', 'health-drain', false);
		createPrefItem('ghostTapping', 'ghostTapping ', true);
		createPrefItem('flashing menu', 'flashing-menu', true);
		createPrefItem('Camera Zooming on Beat', 'camera-zoom', true);
		createPrefItem('Auto Pause', 'auto-pause', false);
		createPrefItem('Color', 'colour', true);
	...
	public static function initPrefs():Void
	{
		...
		preferenceCheck('health-drain', false);
		preferenceCheck('ghostTapping', true);
		preferenceCheck('flashing-menu', true);
		preferenceCheck('camera-zoom', true);
		preferenceCheck('auto-pause', false);
		preferenceCheck('colour', true);
		...
		FlxG.colour = getPref('colour');
		ClientPref.ghostTapping = getPref('ghostTapping');
	}
